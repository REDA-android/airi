...
//
// NOTICE:
// These tables stay in the schema during the expand migration so Drizzle
// does not drop them. Runtime checkout and webhook no longer write them.
// Remove this file in the contract migration after in-progress Stripe
// Sessions finish, expire, or get manual handling.
