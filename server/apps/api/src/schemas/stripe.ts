...
// NOTICE:
// These tables are unused at runtime. drizzle-kit generate diffs this
// schema and emits DROP if they are removed. Old replicas still use the
// SQL tables during a rolling deploy.
// Source: server/apps/api/drizzle/0023_payment_order.sql
// Removal condition: a later SQL migration drops the tables after this
